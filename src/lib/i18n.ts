...
export const siteCopy = {
  en: {
    ...
    adminMissingEnglishFields: "Complete the missing English fields before saving:",
    adminMissingSpanishFields: "Complete the missing Spanish fields before saving:",
  ...
  es: {
    ...
    adminMissingEnglishFields: "Completá los campos faltantes en inglés antes de guardar:",
    adminMissingSpanishFields: "Completá los campos faltantes en español antes de guardar:",
    adminLanguageEnglish: "English",
    adminLanguageSpanish: "Español",
