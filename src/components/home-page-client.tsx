    ...
    <div className="home-page">
      <section className="hero-panel">
        ...
        <aside className="hero-aside">
          <div className="portrait-card portrait-card--hero">
            <img src="/uploads/lucas-portrait-formal.png" alt="Lucas Monzón portrait" className="portrait-image" />
          </div>
      ...
      <section className="about-visual">
        <div className="about-visual__image">
          <img src="/uploads/lucas-portrait-smiling.png" alt="Lucas Monzón profile" className="about-profile-image" />
        </div>
